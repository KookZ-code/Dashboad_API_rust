...
use crate::{errors::AppResult, handlers::AppState, models::ApiResponse, repositories::da_repo::DaRepo};
...
pub async fn get_packages(
    ...
    let repo = DaRepo::new(&s.mssql, &s.config.view_name, &s.config.machine_table);
